          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full p-3 pr-11 bg-slate-50 border border-slate-300 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-[#CE2328] focus:bg-white transition-all font-medium"
